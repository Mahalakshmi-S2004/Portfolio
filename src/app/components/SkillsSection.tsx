  ...
  const skillCategories = [
    {
      ...
      icon: Code2,
      color: "text-blue-500",
      skills: ["C++", "Java", "Python", "SQL", "HTML", "CSS", "JavaScript (Basic)"]
    },
    {
    ...
    },
    {
      ...
      skills: ["Git", "GitHub", "VS Code", "XAMPP", "Google Colab", "Wordpress"]
    },
    {
      title: "Core Concepts",
      icon: Brain,
      color: "text-red-500",
      skills: ["Object-Oriented Programming", "Authentication", "API Development"]
    }
  ];
            ...
            <CardContent className="p-6">
              <div className="text-center">
                ...
                <div className="flex flex-wrap justify-center gap-3">
                  ...
                  <Badge className="bg-purple-600 hover:bg-purple-700 text-white">Communication</Badge>
