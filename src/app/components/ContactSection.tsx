                ...
                <CardContent className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:mahalakshmisaravanan404@gmail.com"
                        className="text-muted-foreground hover:text-primary transition-colors"
                      >
                        mahalakshmisaravanan404@gmail.com
                      </a>
                    </div>
                  </div>
              ...
              <Card className="shadow-lg">
                ...
                <CardContent>
                  <div className="flex gap-4">
                    <a
                      href="https://www.linkedin.com/in/mahalakshmi-saravanan-656568344"
                      target="_blank"
                    ...
                    <a
                      href="https://github.com/Mahalakshmi-S2004"
                      target="_blank"
                      rel="noopener noreferrer"
                    >
                    <Button
